...
Consider the following role skeleton, note the missing *vars* and *test* folder and the newly added [Molecule folder](../development/testing.md#molecule){ data-preview }.
